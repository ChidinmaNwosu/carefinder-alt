...
function Faq(): React.JSX.Element {
  ...
  const toggleOpen = (): any => setIsOpen(!isOpen);
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="flex items-center justify-between mb-[10px]">
              ...
              <h4 className="text-xl">
                Why you should believe in Carefinder, to find healthcare centers
                close to you?
              </h4>
              {/*icon */}
            ...
            >
              <p className="font-light ">
                ...
                eaque maxime quisquam? Dolor deleniti voluptate ratione ut modi
                magnam iure voluptas consectetur dolores! Numquam, dolor rerum
                corporis earum natus dicta.
              </p>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-[10px]">
              {/*title */}
              <h4 className="text-xl">
                How long will it take to get locations of healthcare centers
                closest to me?
              </h4>
              {/*icon */}
              <div className="text-manthis-green text-2xl">
          ...
          >
            <div className="flex items-center justify-between mb-[10px]">
              {/*title */}
              <h4 className="text-xl">
                What preparations are necessary before going to locations
                provided by Carefinder?
              </h4>
              {/*icon */}
              <div className="text-manthis-green text-2xl">
                {isOpen ? <IoMdRemove /> : <IoMdAdd />}
