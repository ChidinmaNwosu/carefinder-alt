...
function Blog(): React.JSX.Element {
  return (
    <section className="className mt-28" id="blog">
      <div className="container mx-auto md:px-40 lg:px-0">
        <h2 className="text-3xl mb-[50px] text-bice-blue text-center xl:text-left font-semibold">
          Our Recent Posts
        </h2>
        {/*Blog posts */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-6 p-4 mb-[50px]">
          {/*blog post 1 */}
          <div className="max-w-[420px] shadow-2xl rounded-[10px] overflow-hidden cursor-pointer">
            {/*image*/}
            <div className="relative">
              <Image
                ...
                src={"/gloves.jpg"}
                alt="Glove pic"
                className="group-hover:scale-110 transition-all duration-500 w-full h-auto"
              />
              {/*badge*/}
          ...
          <div className="max-w-[420px] shadow-2xl rounded-[10px] overflow-hidden cursor-pointer">
            ...
            <div className="px-5 py-6">
              ...
              <p className="font-light">
                ...
                diagnosed with a condition, everyone feels this way. To
                reduce the level of fear that you feel there are certain
                foods to avoid to prevent the early
