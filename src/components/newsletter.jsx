        ...
        <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-x-[58px]">
                ...
                <div className="flex-1 z-10 text-center md:text-left">
                    ...
                    <h1 className=" text-3xl xl:text-6xl mb-4 text-white">Subscribe to get more updates</h1>
                </div>
                {/*newsletter form*/}
                <form action="" className="flex-1">
                    <div className="flex flex-col md:flex-row relative gap-y-4">
                        ...
                        <button className="text-base font-medium uppercase text-gray-400 rounded-full py-5 px-10 bg-white md:absolute right-0">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
